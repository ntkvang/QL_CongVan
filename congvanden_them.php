				...
				<div class="card-body">
					<?php
						if(isset($_POST['Nguoiky']))
						{
							...
							//$Nguoinhan=addslashes($_POST['Nguoinhan']);
							$Tongtrang=addslashes($_POST['Tongtrang']);
							...
							//else
								//sif(trim($Nguoinhan) == "")
								//ThongBaoLoi("Người nhận không được bỏ trống!");
							else
								if(trim($Tongtrang) == "")
							...
							{
								$sql="INSERT INTO `congvande`(`Nguoiky`, `Nguoiduyet`, `Ngaybanhanh`, `Noibanhanh`, `Ngaynhan`, `Nguoinhan`, `Tongtrang`, `Loaivanban`, `Linhvuc`, `Noidungtomtat`, `Noidungvanban`, `Filedinhkem`, `Ghichu`) VALUES ('$Nguoiky','$Nguoiduyet',now(),'$Noibanhanh',now(),'$Nguoinhan',$Tongtrang,'$Loaivanban','$Linhvuc','$Noidungtomtat','$Noidungvanban','$Filedinhkem','$Ghichu')";
					...
					?>
					<form method="post" action="congvanden_them.php">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="Tongtrang">Tổng số trang</label>
								<input type="text" class="form-control" id="Tongtrang" name="Tongtrang" placeholder="" required />
							</div>
