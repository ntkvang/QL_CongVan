...
<html lang="en">
	...
	<body>
		<div class="container">
			...
			<div class="card" style="margin-top: 10px;margin-left: -80px; margin-right:50px; " >
							...
							echo "<div class=list-group>";
								//echo "<div class='card list-books'>";
									echo "<div class='card-body'>";
										...
										echo"<h7 class='card-tittle'>Người nhận: {$dong['Nguoinhan']}</h7>";

										echo "<p class='card-text'> Tổng số trang: {$dong['Tongtrang']}</p>";
