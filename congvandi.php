	...
	<body>
		<div class="container">
			...
			<div class="card">
				...
				<div class="card-body">
					<p><a class="btn btn-primary" href="congvandi_them.php" role="button">Thêm công văn đi</a></p>
							...
							<?php
								while($dong = mysqli_fetch_array($danhsach))
								{
									echo "<tr>";
										...
										echo "<td>{$dong['Nguoigoi']}</td>";
										echo "<td>{$dong['Tongsotrang']}</td>";
										...
										echo "<td>{$dong['Ghichu']}</td>";
											echo "<td class='text-center'><a href='congvandi_sua.php?id={$dong['ID']}'><img src='img/edit.png' /></a></td>";
											echo "<td class='text-center'><a onclick='return confirm(\"Bạn có muốn xóa công văn đi {$dong['Loaivanban']} không?\");' href='congvandi_xoa.php?id={$dong['ID']}'><img src='img/delete.png' /></a></td>";
